    ...
    public partial class CSGO
    {
        ...
        public class Config
        {
            ...
            public class MultiPlayer
            {
                ...
                public static string EnableOnlyHeadShotsDamage(bool Enable) =>
                    $"mp_damage_headshot_only {(Enable ? "1" : "0")}";
                ...
                public static string AllowDropDefuseKitWithDeath(bool Enable) =>
                    $"mp_death_drop_defuser {(Enable ? "1" : "0")}";
                ...
                public static string SetInfiniteWarmupTime(bool Enable) =>
                    $"mp_warmup_pausetimer {(Enable ? "1" : "0")}";
            ...
            public class Server
            {
                ...
                public static string EnableAutoBunnyHopping(bool Enable) =>
                    $"sv_autobunnyhopping {(Enable ? "1" : "0")}";
                ...
                public static string EnableHealthAutoRecovery(bool Enable) =>
                    $"sv_regeneration_force_on {(Enable ? "1" : "0")}";
                ...
                public static string EnableShowImpactsExtraInfo(bool Enable) =>
                    $"sv_showimpacts_penetration {(Enable ? "1" : "0")}";
                ...
                public static string EnableShowGredeTrajectory(bool Enable) =>
                    $"sv_grenade_trajectory {(Enable ? "1" : "0")}";
