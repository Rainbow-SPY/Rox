...
namespace Rox.Runtimes
{
    ...
    public class Network_I
    {
        ...
        public static async Task<PingResult> PingAsync(string target, int timeout = DefaultPingTimeout)
        {
        ...
        public static async Task<List<PingResult>> BatchPingAsync(IEnumerable<string> targets,
        ...
        public static bool Ping(string target, int timeout = DefaultPingTimeout) =>
        ...
        public static long? GetPingDelay(string target, int timeout = DefaultPingTimeout) =>
        ...
        private static async Task<string> ResolveDomainToIpAsync(string domain) =>
            // 若已是 IP 地址，直接返回
